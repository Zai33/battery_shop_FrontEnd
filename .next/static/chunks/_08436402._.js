...
const Voucher = (param)=>{
    let { data } = param;
    var _data_buyback, _data_createdBy;
    _s();
    const voucherRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const handleDownload = async ()=>{
        ...
        try {
            ...
            const imgData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$html$2d$to$2d$image$2f$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toPng"])(voucherRef.current, {
                cacheBust: true,
                pixelRatio: 2
            });
            ...
            pdf.save("voucher_".concat(data.carNumber, ".pdf"));
        } catch (err) {
...
_s(Voucher, "VeqKwY9Lqp8+uh07x5DfxJ4MPe8=");
_c = Voucher;
...
//# sourceMappingURL=_08436402._.js.map