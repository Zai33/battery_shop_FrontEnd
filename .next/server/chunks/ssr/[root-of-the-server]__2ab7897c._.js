...
"[project]/app/dashboard/sale/components/SaleList.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SaleList = ()=>{
    ...
    const fetchSales = async (page = 1)=>{
        try {
            setIsLoading(true);
            const token = localStorage.getItem("token") || "";
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$libs$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GetAllSales"])(token, page);
            if (res.con) {
                setSales(res.result);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2ab7897c._.js.map